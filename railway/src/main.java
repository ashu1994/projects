...
public class main extends Applet implements ActionListener {
	...
	public void init() {
		...
		timebox.setBounds(1000, 30, 80, 30);
		add(timebox);
		b = new Button("Simulator");
		b1=new Button("Schedule");
		b.setBounds(700, 530, 100, 50);
		b1.setBounds(850,530,100,50);
	...
	public void actionPerformed(ActionEvent ae) {
		if (ae.getActionCommand() == "Simulator")
			new GUI();
		else if (ae.getActionCommand() == "Schedule")
			td.Display(); 
	}
	...
	public void paint(Graphics e) {
		...
		try {
			...
			for(Train t:sd2.outerleft){
				...
				e.setColor(Color.white);
				e.drawString(Integer.toString(t.no),40, 125 + 70 *a + 30);				
				a++;
				if(a>=2)break;
			}
			a=0;
			for(Train t:sd2.outerright){
				...
				e.setColor(Color.white);
				e.drawString(Integer.toString(t.no),1250, 125 + 70 *a + 30);				
				a++;
				if(a>=2)break;
			}
